...
public class keywordDemo_public_private_protected_default {
	...
	/** PRIVATE methods/variables CANNOT be accessed outside the CLASS, even in same packages  */
	private void privateMethod() {
		
	}
	
	/** PROTECTED methods/variable 
	 *  - in the SAME PACKAGE, CAN be accessed from CHILD CLASSES (subclasses, extends it) directly
	 *    	(example: section38_JavaOOP_Part2_tutorial.corejava.staticVariable2_StaticBlocks)
	 *  - in OTHER PACKAGES, CAN be accessed from CHILD CLASSES (subclasses, extends it) after invoked its instance
